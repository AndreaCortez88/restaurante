...
class Postres(models.Model):
    ...
    precio_post = models.DecimalField(null=False, blank=False, max_digits=7, decimal_places=2)
...
class Extras(models.Model):
    ...
    precio_ext = models.DecimalField(null=False, blank=False, max_digits=7, decimal_places=2)
